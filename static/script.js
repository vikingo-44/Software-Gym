    ...
    editorForm.onsubmit = async (e) => {
		...
		*/
		...
		window.loadCaja = async function() {
            ...
            // Traemos los movimientos de la API (El administrador ve global si queryParams está vacío)
            ...
            // 5. ACTUALIZACIÓN DE TARJETAS (Ahora son 100% dinámicas según el filtrado aplicado)
